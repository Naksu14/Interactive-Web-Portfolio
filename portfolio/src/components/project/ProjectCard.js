...
const ProjectBlock = ({
  ...
  return (
    <div
      className={`mt-5 mb-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 grid-rows-3 gap-4 px-4 md:px-8 lg:px-16 xl:px-32`}
    >
      <div
          className={`${
        ...
        >
          <div className="w-[80%] h-[350px] sm:h-[400px] md:h-[450px] lg:h-[500px] xl:h-[500px] bg-[#18161F] rounded-lg p-4 border-t border-white border-b border-gray-400">
